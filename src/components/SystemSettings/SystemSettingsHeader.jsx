...
function SystemSettingsHeader({ activeTab, tabs, keyword, onKeywordChange, onTabChange }) {
  return (
      ...
      <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
        <div>
          <nav className="text-sm font-semibold text-slate-500">
            Admin Portal / <span className="text-blue-700">Cài đặt hệ thống</span>
          </nav>
          <h1 className="mt-2 text-2xl font-black text-slate-950 sm:text-3xl">Cài đặt hệ thống</h1>
          <p className="mt-2 max-w-3xl text-sm font-medium text-slate-500">
            Quản lý nhân viên, phân quyền truy cập và các tham số vận hành cốt lõi của trung tâm.
          </p>
        </div>
        ...
        <div className="flex h-11 w-full items-center gap-2 rounded-xl border border-gray-300 bg-slate-50 px-3 xl:w-[420px]">
          ...
          <input
            ...
            placeholder="Tìm nhân viên, vai trò, cấu hình"
            value={keyword}
